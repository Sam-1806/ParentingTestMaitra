...
>
  ...
  ></div>
    ...
    zIndex: 10, // Higher value to bring it above any overlays
    backgroundColor:
      answers[currentQuestionIndex] === optionKey ? "#4CAF50" : "#fff",
    color: answers[currentQuestionIndex] === optionKey ? "#fff" : "#333",
    border: "2px solid #4CAF50",
    padding: "12px 20px",
    margin: "10px 0",
    width: "80%",
